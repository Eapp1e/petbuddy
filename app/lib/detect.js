...
const CATALOG = [
  ...
  },
  {
    ...
    processNames: ['gemini.exe'],
    site: 'gemini.google.com', ports: [],
  ...
  },
  {
    ...
    processNames: ['qwen.exe'],
    site: 'qwenlm.github.io', ports: [],
  ...
  },
  {
    ...
    processNames: ['goose.exe'],
    site: 'block.github.io', ports: [],
  ...
  },
  {
    ...
    processNames: ['amp.exe'],
    site: 'ampcode.com', ports: [],
  ...
  },
  {
    ...
    processNames: ['Code.exe'],
    site: 'code.visualstudio.com', ports: [],
