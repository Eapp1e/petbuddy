...
这是 PetBuddy 的核心卖点：**一条命令，把你的所有 AI Agent 接到同一只桌宠上**。
...
> 💡 内置预设（Codex / Claude Code / WorkBuddy / ZCode / DSH）只是几个例子，不是支持范围的边界——
> **任何**有钩子机制（Claude 风格 / 配置文件钩子）或能发 HTTP 的 Agent 都能接入：Cline、Roo Code、Aider、OpenHands……
...
- **10 种圆环样式**：经典光弧 / 双环反转 / 缺口旋转 / 彗尾追踪 / 脉冲外扩 / 追光三点 / 虚线段环 / 彩虹流转 / 辉光呼吸 / 双向扫描
...
<p align="center">
  <img src="docs/07-panel.png" width="32%" alt="任务面板">
  <img src="docs/08-pet-lulu.png" width="32%" alt="形象：噜噜">
  <img src="docs/09-pet-tiko.png" width="32%" alt="形象：Tiko">
  <br/>
  <img src="docs/10-pet-eve.png" width="32%" alt="形象：EVE">
  <img src="docs/04-done.png" width="32%" alt="完成">
  <img src="docs/05-idle.png" width="32%" alt="空闲">
</p>
...
<p align="center">
  <img src="docs/11-settings.png" width="42%" alt="设置窗口">
  <img src="docs/06-rest.png" width="42%" alt="休息提醒">
</p>
...
欢迎 Issue 和 PR！新增应用接入样式、新的圆环特效、形象动画适配都是很好的切入点。
